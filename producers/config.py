...
TOPIC_WEATHER_EVENTS = os.environ.get("TOPIC_WEATHER_EVENTS", "nyc_weather_events")
TOPIC_PASSENGER_SURGES = os.environ.get("TOPIC_PASSENGER_SURGES", "mta_passenger_surges")
